...
def run_agent(user_input: str,base64_image:str, config: dict = None) -> Generator[dict, None, None]: # type: ignore
    """
    ...
    initial_state = {"messages": [
            ("user",  user_input),
            ("user", f"Image URL: data:image/png;base64,{base64_image}"),
        ]}
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            # print("Base64 image saved to base64_image.txt")
            for event in run_agent(user_input,base64_image):
